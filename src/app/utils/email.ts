...
export const sendOrderConfirmationEmail = async ({
  ...
  <div style="font-family: Arial, sans-serif; padding: 20px; background: #f9f9f9; border-radius: 10px;">
    ...
    <p style="color: orange;">🚚 Delivery Status: Pending</p>
...
`;
  ...
  const userMailOptions = {
    ...
    to,
    subject: `🛍️ Order Confirmation - Order #${orderId}`,
    html: userEmailHtml,
  };
  ...
  const adminMailOptions = {
    from: '"MirexaStore" <mdeasinsarkar01@gmail.com>',
    to: "mdeasinsarkar01@gmail.com", // Change this to your admin email
  ...
  try {
    ...
    console.log(`✅ Order confirmation email sent to user (${to}) and admin.`);
  } catch (error) {
